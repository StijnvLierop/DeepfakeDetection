...
class Dataset(ABC, Iterable[Instance], Sized):
    ...
    def save(self, path: Path, encoder: JSONEncoder = None) -> None:
        """
        ...
        :param encoder: The JSON encoder to use for encoding the dataset.
        """
        ...
        with open(path, "w") as outfile:
            ...
            # Encode to JSON
            json.dump(instances, outfile, cls=encoder)